    ...
    <div className={`app-container theme-${theme}`}>
      ...
      <nav className="top-navbar">
        <div className="top-nav-left">
          <h1 className="app-logo">🧠 DyslexiaAid</h1>
        </div>
        <div className="top-nav-right">
          <div className="theme-selector">
            <button className={`theme-btn ${theme==='light'?'active':''}`}    onClick={()=>toggleTheme('light')}    title="Light">☀️</button>
            <button className={`theme-btn ${theme==='dark'?'active':''}`}     onClick={()=>toggleTheme('dark')}     title="Dark">🌙</button>
          </div>
